...
const Hero = () => {
  ...
  return (
    <section className="h-screen xl:h-[800px] mb-16 relative pt-[env(safe-area-inset-top)]">
      ...
      <div className="absolute bg-[var(--color-tertiary)] top-0 left-0 w-[50vw] h-full bg-hero-1  bg-blend-color-dodge bg-no-repeat bg-cover -z-10 "></div>
      <div className="absolute bg-[var(--color-tertiaryy)] top-0 right-0 w-[50vw] h-full bg-hero-2  bg-blend-lighten bg-no-repeat bg-cover -z-10 "></div>
    </section>
  );
};
